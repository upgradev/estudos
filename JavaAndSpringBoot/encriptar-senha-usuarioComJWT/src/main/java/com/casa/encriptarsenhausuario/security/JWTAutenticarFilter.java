package com.casa.encriptarsenhausuario.security;
...
public class JWTAutenticarFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public static final String TOKEN_SENHA = "e122d388-3689-4878-a0f7-129022509f56";
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new RuntimeException("Falha au autenticar usuario.", e);
        }
